      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-3 flex gap-3 overflow-x-auto scrollbar-hide px-0.5 sm:px-0 pb-1 max-w-full">
          {specials.map((dish) => {
            ...
            return (
              <div key={dish.id} className="w-32 sm:w-40 shrink-0 bg-zcard border border-zborder rounded-2xl overflow-hidden shadow-sm card-lift">
                ...
                <div className="p-2.5">
                  <h3 className="text-xs font-bold text-ztext truncate">{dish.name}</h3>
